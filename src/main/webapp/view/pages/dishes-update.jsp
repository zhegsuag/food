...
<body class="hold-transition skin-purple sidebar-mini">
	...
	<div class="wrapper">
		...
		<form action="${pageContext.request.contextPath}/dishes/saveUpdate" method="post" enctype="multipart/form-data">
			<!-- 正文区域 -->
					...
					<div class="tab-pane active" id="tab-label">
						<div class="row data-type">
							...
							<div class="col-md-4 data text">
								<input type="text" name="dishesName" class="form-control" value="${dishes.dishesName}"
									value="">

							</div>
							<div class="col-md-2 title">原料</div>
							<div class="col-md-4 data text">
								<input type="text" name="material" class="form-control" value="${dishes.material}"
									value="">
							</div>
							...
							<div class="col-md-4 data text">
								<div class="input-group">
									<span class="input-group-addon">¥</span>
									<input type="text" name="vipPrice" class="form-control" value="${dishes.vipPrice}">
									<span class="input-group-addon">.00</span>
								</div>
							</div>
							...
							<div class="col-md-4 data text">
								<select class="form-control" name="dishesTypeId">
									...
									<option value="${type.id}"
											<c:if test="${type.id == dishes.dishesTypeId}">
                                            selected="selected"
									</c:if>>
											${type.typeName }
									</option>
							...
							<div class="col-md-10 data rowHeight2x">
								<textarea name="desc" class="form-control"  rows="3" value="${dishes.desc}">${dishes.desc}</textarea>
							</div>
						</div>
					</div>
